...
if(mysqli_num_rows($result) > 0){
    ...
    //insert variables into database users
    ...
    $mysqli->query($query);
    $message = "You have successfully creat an account!"; //alert
    echo "<script type='text/javascript'>alert('$message');</script>";
    $url = "Manager_account.php?";   //go to sign in page
    echo "<script type='text/javascript'>";
    echo "window.location.href='$url'";
    echo "</script>";
    ...
    $BSB="017324";
    //insert account details to database
